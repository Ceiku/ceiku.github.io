...
{% include figure image_path="/assets/images/ha_dash.jpg" alt="a home-assistant dashboard" caption="A simple dashboard that unifies a lot of brands and services into one interface -- Home-Assistant" %}
